...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg bg-primary navbar-dark  fixed-top py-3" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="">Barber Shop</a>
                ...
                <div class="row">
                    <div class=" col-md-4">
                        <div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><a class="btn btn-primary" href="../../client-scheduling/">Agendar Horário</a></h5>
                                <p class="card-text">Faça seu agendamento clicando no botão</p>
                            </div>
                        </div>
                    </div>
                    <div class=" col-md-4">
                        <div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Encontre a barbearia mais próxima clicando no botão acima.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                 ...
                 <div class="row">
                    <div class=" col-md-4">
                        <div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><a class="btn btn-primary" href="../../invite-client/">Convidar Cliente</a></h5>
                                <p class="card-text">Indique amigos e ganhe descontos</p>
                            </div>
                        </div>
                    </div>    
                     <div class="col-md-4">
