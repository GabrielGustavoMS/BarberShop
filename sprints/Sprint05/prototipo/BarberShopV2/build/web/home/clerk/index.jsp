                ...
                <div class="row">
                    ...
                    <div class=" col-md-4">
                        <div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><a class="btn btn-primary" href="../../mail/">Comunicar gerência</a></h5>
                                <p class="card-text">Entre em contato com a sua gerência clicando no botão acima</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><a class="btn btn-primary"  href="../../my-schedulings/">Consultar Agendamentos</a></h5>
                                <p class="card-text">Consulte os agendamentos de clientes que você realizou</p>
                            </div>
                        </div>
                    </div>
                </div>
