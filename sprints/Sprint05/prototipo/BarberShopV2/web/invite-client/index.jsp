    ...
    <body id="page-top">
        ...
        <section class="container h-100 ">
            <section class="row h-100 align-items-center justify-content-center text-center">
                <form>
                    <section class="mb-5">
                        <h1 class="text-primary mb-5" >Convide amigos e ganhe descontos</h1>
                        <small>
                            <h5 class="text-center">Se o novo cliente fechar o negócio você ganhará descontos</h5>
                        </small>
                    ...
                    <section class="input-group mt-5">
                        ...
                        <input id="email" type="email" placeholder="Digite o e-mail" class="form-control">
                    </section>

                    <section class=" mt-4">

                        <a class="btn btn-primary btn-block mt-2 mb-2" href="../home/client/">Convidar</a>
                        <small class=" mt-5"><a href="../home/client/">Voltar</a></small>
                    </section>
